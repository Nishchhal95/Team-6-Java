...
public class ART_B extends JFrame {
	...
	public  ART_B() {
		...
		JLabel lblNewLabel = new JLabel("Art B");
		lblNewLabel.setBounds(299, 43, 61, 16);
		...
		lblNewLabel_2.setBounds(172, 117, 105, 16);
		...
		lblNewLabel_13.setBounds(226, 318, 348, 16);
		...
		btnNewButton.setBounds(217, 342, 165, 29);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Dashboard d22 = new Dashboard();
				d22.setVisible(true);
				setVisible(false);
				dispose();
			}
		});
		btnNewButton_1.setBounds(116, 405, 117, 29);
		contentPane.add(btnNewButton_1);
		
		JButton btnNewButton_2 = new JButton("Art Gallery");
		...
		btnNewButton_2.setBounds(393, 405, 117, 29);
		contentPane.add(btnNewButton_2);
		
		textField = new JTextField();
		textField.setEditable(false);
		textField.setColumns(10);
		textField.setBounds(349, 80, 130, 26);
		contentPane.add(textField);
		
		textField_1 = new JTextField();
		textField_1.setEditable(false);
		textField_1.setColumns(10);
		textField_1.setBounds(349, 112, 130, 26);
		contentPane.add(textField_1);
		
		textField_2 = new JTextField();
		textField_2.setEditable(false);
		textField_2.setColumns(10);
		textField_2.setBounds(349, 144, 130, 26);
		contentPane.add(textField_2);
		
		textField_3 = new JTextField();
		textField_3.setEditable(false);
		textField_3.setColumns(10);
		textField_3.setBounds(349, 176, 130, 26);
		contentPane.add(textField_3);
		
		textField_4 = new JTextField();
		textField_4.setEditable(false);
		textField_4.setColumns(10);
		textField_4.setBounds(349, 210, 130, 26);
		contentPane.add(textField_4);
		
		textField_5 = new JTextField();
		textField_5.setEditable(false);
		textField_5.setColumns(10);
		textField_5.setBounds(349, 248, 130, 26);
		...
		btnNewButton_3.setBounds(245, 405, 117, 29);
