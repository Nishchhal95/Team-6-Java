...
public class ArtistD extends JFrame {
	...
	public ArtistD() {
		...
		JLabel lblNewLabel = new JLabel("Artist D");
		...
		textField.setBounds(345, 80, 130, 26);
		...
		textField_1.setBounds(345, 112, 130, 26);
		contentPane.add(textField_1);
		
		textField_2 = new JTextField();
		textField_2.setEditable(false);
		textField_2.setColumns(10);
		textField_2.setBounds(345, 144, 130, 26);
		contentPane.add(textField_2);
		
		textField_3 = new JTextField();
		textField_3.setEditable(false);
		textField_3.setColumns(10);
		textField_3.setBounds(345, 176, 130, 26);
		contentPane.add(textField_3);
		
		textField_4 = new JTextField();
		textField_4.setEditable(false);
		textField_4.setColumns(10);
		textField_4.setBounds(345, 210, 130, 26);
		contentPane.add(textField_4);
		
		textField_5 = new JTextField();
		textField_5.setEditable(false);
		textField_5.setColumns(10);
		textField_5.setBounds(345, 248, 130, 26);
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Artists AL11 = new Artists();
				AL11.setVisible(true);
				
				setVisible(false);
				dispose();
			}
		});
		btnNewButton_2.setBounds(227, 395, 159, 29);
